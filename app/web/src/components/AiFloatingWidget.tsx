  ...
  const sendMessage = async (textToSend?: string) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: 'assistant',
          content: 'Disculpa, ocurrió un error consultando el asistente: ' + (err as Error).message,
        },
      ]);
    } finally {
      setLoading(false);
          ...
          <div className="p-3.5 bg-gradient-to-r from-indigo-700 via-purple-700 to-sky-700 text-white flex items-center justify-between shadow-sm shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/80">Preguntas básicas a complejas · Activo</p>
              </div>
            </div>
            <button
              type="button"
